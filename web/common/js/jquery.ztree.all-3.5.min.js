...
(function(p) {
    var G, H, I, J, K, L, r = {}, u = {}, v = {}, M = {
        ...
        a.bind(c.SELECTED, function(a, c, g, l) {
      ...
      , i = {
        ...
        appendNodes: function(b, a, c, d, f, g) {
            ...
            for (var e = [], j = b.data.key.children, k = 0, m = c.length; k < m; k++) {
                ...
                i.makeDOMNodeNameAfter(e, b, n),
                h.getAfterA(b, n, e),
                n.isParent && n.open && i.makeUlHtml(b, n, e, t.join("")),
        ...
        cancelPreSelectedNode: function(b, a, c) {
            ...
            for (f = d.length - 1; f >= 0; f--)
                if (g = d[f],
                a === g || !a && (!c || c !== g))
                    if (k(g, e.id.A, b).removeClass(e.node.CURSELECTED),
                    a) {
        ...
        expandCollapseNode: function(b, a, c, d, f) {
            ...
            if (a) {
                ...
                if (a.open == c)
                    ...
                    a.iconOpen && a.iconClose && o.attr("style", i.makeNodeIcoStyle(b, a)),
                    a.open ? (i.replaceSwitchClass(a, g, e.folder.OPEN),
                    i.replaceIcoClass(a, o, e.folder.OPEN),
                    ...
                    i.replaceIcoClass(a, o, e.folder.CLOSE),
            ...
            if (h.getNodeCache(b, a.tId)) {
                ...
                if (!b.data.keep.parent && g == 0)
                    ...
                    var o = f[d][g - 1]
                      ...
                      , l = k(o, e.id.SWITCH, b);
                    j = k(o, e.id.ICON, b);
                    f == c ? f[d].length == 1 ? i.replaceSwitchClass(o, l, e.line.ROOT) : (c = k(f[d][0], e.id.SWITCH, b),
